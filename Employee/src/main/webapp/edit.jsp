  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
        ...
        <div class="sidebar-brand-text mx-0">GROUP - 6 <sup></sup></div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="download.jfif">
              </a>
	...
	<form action="EmployEdit" method="post">
                                            ...
                                            <tr>
                                               <td>Employee's ID</td>
												...
												<td>	<input type="text" name="edit1" value="<%=employ.getId() %>" class="form-control"  ></td>
												
                                            </tr>
                                               <tr>
                                               
												<td>Employee's Code</td>
												<td>	<input type="text" name="edit2" value=<%=employ.getManv() %> class="form-control"  ></td>
												
                                            </tr>
                                               <tr>
                                               
												<td>Employee's Name</td>
												<td>		<input type="text" name="edit3" value="<%=employ.getTennv() %>" class="form-control"  ></td>
												
                                            </tr>
                                             <tr>
                                               
												<td>Address</td>
												<td>	<input type="text" name="edit4" value="<%=employ.getDc() %>" class="form-control"  > </td>
												
                                            </tr>
                                                <tr>
                                               
												<td>Phone Number</td>
												<td>	<input type="text" name="edit5"  value="<%=employ.getSdt() %>" class="form-control"  > </td>
												
                                            </tr>
                                            <tr><button type="submit" class="btn btn-submit btn btn-primary">Edit</button></tr>
                                        	</form>
                                        </tbody>
